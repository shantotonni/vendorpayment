...
<div class="container">
    <div style="text-align: center;background: #ffffff;padding: 5px;">
        <div style="text-align: center;background: #ffffff;padding: 10px;margin-bottom: 10px">
            <a href="" style="text-decoration: none">
                ...
                <span style="font-size: 14px;margin-left: 10px;color: black;"><?php echo $report['one'][0]['CompanyName']; ?></span>
            </a>
    ...
    <div style="text-align: center">
        <h3>Statement of payment</h3>
<!--        <p style="font-size: 12px">Details of Bill</p>-->
    </div>
    <div class="row">
        <div class="col-md-8">
            <p style="font-size: 12px">Business : <?php echo $report['two'][0]['Business']; ?></p>
        </div>
        <div class="col-md-4">
            <p style="text-align: right;font-size: 12px">Issue Date : <?php echo date('Y-m-d'); ?></p>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <!--    <p style="font-size: 12px;margin: 0px">Bill Prepared by : --><?php //echo $report['two'][0]['PreparedBy']; ?><!--</p>-->
            <p style="font-size: 11px;font-weight: bold">Disclaimer :</p>
            <p style="font-size: 10px">This computer generated statement issued for information only and it contains no evidentiary value. For final confirmation and official document, please contact with the concerned.</p>
        </div>
    </div>
</div>
<?php
